#define FASTJET_PACKAGE_STRING  "FastJet 3.4.0-beta.1"
#define FASTJET_PACKAGE_VERSION  "3.4.0-beta.1"
#define FASTJET_VERSION  "3.4.0-beta.1"
#define FASTJET_VERSION_MAJOR       3
#define FASTJET_VERSION_MINOR       4
#define FASTJET_VERSION_PATCHLEVEL  0
#define FASTJET_VERSION_PRERELEASE  "beta.1"
